...
async function createEmbed(text: string) {
    try {
...
async function clearPineconeIndex(index: any) {
    try {
...
async function loadCSVData(filePath: string): Promise<CSVRow[]> {
...
function createBatches(data: CSVRow[], batchSize: number): CSVRow[][] {
...
async function processBatch(batch: CSVRow[], index: any, startId: number): Promise<number> {
    const vectors = [];
